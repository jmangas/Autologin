...
![Architecture](/sample-apps/autologin/images/sample-autologin.png)
...
Download or clone this repository.
    ...
    $ cd aws-lambda-developer-guide/sample-apps/autologin

To create a new bucket for deployment artifacts, run `1-create-bucket.sh`.

    autologin$ ./1-create-bucket.sh
    make_bucket: lambda-artifacts-a5e491dbb5b22e0d

# Deploy
To deploy the application, run `2-deploy.sh`.

    autologin$ ./2-deploy.sh
    ...
    Successfully created/updated stack - autologin
...
![Service Map](/sample-apps/autologin/images/autologin-servicemap.png)

Choose a node in the main function graph. Then choose **View traces** to see a list of traces. Choose any trace to view a timeline that breaks down the work done by the function.

![Trace](/sample-apps/autologin/images/autologin-trace.png)
...
2. Choose **autologin**.
  ...
  ![Application](/sample-apps/autologin/images/autologin-application.png)

# Cleanup
To delete the application, run `5-cleanup.sh`.

    autologin$ ./5-cleanup.sh
